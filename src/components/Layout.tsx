...
import { FileText, LayoutDashboard, Menu, Package, Settings, Undo2 } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'Einkaufsliste';
...
const navigation = [
  ...
  { name: 'Einkaufsartikel', href: '/einkaufsartikel', icon: Package },
  { name: 'Einkäufer', href: '/einkaeufer', icon: FileText },
  { name: 'Einkaufsliste', href: '/einkaufsliste', icon: FileText },
];

const externalNavigation = [
  { name: 'Einkaufsartikel', href: '/gateway/apps/69bce5f8550beea6f03c7e74?template=list_page', icon: Package },
  { name: 'Einkäufer', href: '/gateway/apps/69bce5f2e35329c5b58c58a3?template=list_page', icon: FileText },
  { name: 'Einkaufsliste', href: '/gateway/apps/69bce5f85c5d7cbd7a1ef4ae?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69bce5f8550beea6f03c7e74?template=list_page"
